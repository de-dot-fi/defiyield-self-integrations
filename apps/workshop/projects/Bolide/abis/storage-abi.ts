export const STORAGE_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'blid', type: 'address' }],
    name: 'SetBLID',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'logic', type: 'address' }],
    name: 'SetLogic',
    type: 'event',
  },
  {
  ...
  { inputs: [], name: 'interestFee', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'owner',
  ...
  {
    inputs: [{ internalType: 'address', name: '_blid', type: 'address' }],
    name: 'setBLID',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: 'token', type: 'address' }],
    name: 'updateAccumulatedRewardsPerShare',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
